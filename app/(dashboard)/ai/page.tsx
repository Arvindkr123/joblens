    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="text-center py-10">
                <div className="inline-flex items-center gap-1.5 bg-purple-50 text-purple-700 text-xs font-medium px-3 py-1.5 rounded-full mb-4">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white rounded-xl border border-gray-100 p-5">
                    ...
                    <span className="inline-flex items-center gap-1 mt-3 text-xs font-medium bg-purple-50 text-purple-700 px-2.5 py-0.5 rounded-full">
                        ⚡ Instant
                    </span>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-5">
                    ...
                    <span className="inline-flex items-center gap-1 mt-3 text-xs font-medium bg-teal-50 text-teal-700 px-2.5 py-0.5 rounded-full">
                        📋 Copy ready
                    </span>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-5">
                    ...
                    <span className="inline-flex items-center gap-1 mt-3 text-xs font-medium bg-amber-50 text-amber-700 px-2.5 py-0.5 rounded-full">
                        ✓ Actionable
                    </span>
                </div>
            </div>
            ...
            {/* Application picker */}
            <div className="bg-white rounded-xl border border-gray-100 p-6 mb-6 my-3">
                    ...
                    <div className="flex flex-col gap-2">
                        {applications.map((app) => (
                            <Link
                                ...
                                className="flex items-center justify-between px-4 py-3 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors group"
                            >
            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                    {[
                        ...
                        <div key={item.step} className="bg-white rounded-xl border border-gray-100 p-4">
